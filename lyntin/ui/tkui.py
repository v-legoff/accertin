...
class CommandEntry(Entry):
  ...
  def __init__(self, master, partk, **kw):
    ...
    # JLP: solve backspace problem
    self.bind("<KeyPress-BackSpace>", self.callBackSpace)
  ...
  # JLP: solve backspace problem
  def callBackSpace(self, tkevent):
    """ Handles the <KeyPress-BackSpace> event."""
    bkspcIndex = self.index('insert')
    self.delete(bkspcIndex - 1, bkspcIndex)
